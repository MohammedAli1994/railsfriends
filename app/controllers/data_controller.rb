class DataController < ApplicationController
  ...
  def correct_user
    ...
    redirect_to datum_path, notice: "Not Authorized To edit This Friend" if @datum.nil?
  end
  ...
  private
    ...
    def datum_params
      params.require(:datum).permit(:first_name, :last_name, :email, :Linkdin, :phone, :user_id)
    end
end
